...
this.ModeParser = function(MODE_REGEXP){
	function ModeParser(){
	
	};
	ModeParser = new StaticClass(ModeParser);
...
this.ECMAScript6 = function(ModeParser, ecmaScript6SyntaxMarker, previousParsers, extensibleParsers, nextParsers, toString){
