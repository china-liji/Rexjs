test.unit(
	...
	function(source){
		...
		test.true("子类：super 之后调用 super 的属性", "class A extends B { constructor(){ super(); super.a; } }");
		test.true("子类：构造函数中的箭头函数里使用 super", "class A extends B { constructor(){ super(); let fn = () => { super.a; } } }");
		test.true("子类：构造函数中的箭头函数里使用 super()", "class A extends B { constructor(){ let fn = () => { super(); } } }");
