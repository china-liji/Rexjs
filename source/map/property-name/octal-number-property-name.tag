import { OctalNumberTag } from "../mathematical-number/octal-number.tag";
...
export let OctalNumberPropertyNameTag = function(){
	/**
	 * 八进制数字属性名标签
	 * @param {Number} _type - 标签类型
	 */
	return class OctalNumberPropertyNameTag extends OctalNumberTag {
		/**
		 * 获取此标签接下来所需匹配的标签列表
